  ...
  },
  {
    ...
    icon: (
      <svg
        ...
        fill="currentColor"
      >
        <path d="M22 12.07C22 6.55 17.52 2 12 2S2 6.55 2 12.07c0 4.96 3.59 9.07 8.28 9.87v-6.99h-2.5v-2.88h2.5v-2.2c0-2.45 1.49-3.8 3.69-3.8 1.07 0 2.19.19 2.19.19v2.41h-1.23c-1.21 0-1.58.75-1.58 1.52v1.88h2.69l-.43 2.88h-2.26v6.99C18.41 21.14 22 17.03 22 12.07z" />
      </svg>
    ),
    alt: "Facebook",
  },
    ...
    <section id="contact" className="section">
      <div className="container lg:grid lg: grid-cols-2 lg:items-stretch">
        <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
          <h2 className="abel-regular text-lg headline-2 lg:max-w-[12ch] reveal-up">
            Contact me for collaboration
          </h2>

          <p className="abel-regular text-lg text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch] reveal-up">
        ...
        >
          <div className="abel-regular text-lg md:grid md:items-center md:grid-cols-2 md:gap-2">
            <div className="mb-4">
          ...
          <div className="mb-4">
            <label
              htmlFor="message"
              className="abel-regular text-lg label reveal-up"
            >
              Message
            </label>
            ...
            <textarea
              ...
              placeholder="Hi!"
              required
              className="abel-regular text-lg text-field resize-y min-h-32 max-h-80 reveal-up"
            ></textarea>
          </div>

          <button
            type="submit"
            className="abel-regular text-lg btn btn-primary [&]:max-w-full w-full justify-center reveal-up text-white bg-gradient-to-br from-green-400 to-blue-600 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none 
